...
can be built for Windows with MSVC, MinGW or Linux. The build script will attempts to download and build all dependencies and link them statically. An advantage of this approach is the ability to easily install the debug symbols across different platforms.
